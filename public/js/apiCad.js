  ...
  api
    ...
    .then((result) => {
      ...
      array.forEach((client) => {
        printList.innerHTML += `<li class="list-group-item list-group-item-success">Id: ${client.id} - Name: ${client.name} - Cpf: ${client.cpf} - Email: ${client.email} - Age: ${client.age} </li> `;
      });
    })
    .catch((err) => {
      console.log(err);
...
document.getElementById("searchClient").addEventListener("click", () => {
  ...
  api
    ...
    .then((result) => {
      ...
      printList.innerHTML += `<li class="list-group-item list-group-item-success">Id: ${array.id} - Name: ${array.name} - Cpf: ${array.cpf} - Email: ${array.email} - Age: ${array.age} </li> `;
    })
    .catch((error) => {
      console.log(error);
    });
...
document.getElementById("addTransaction").addEventListener("click", () => {
  ...
  api
    .post(`/clients/${_idClient}/transactions`, {
      title: _title,
      value: _value,
      type: _type,
    })
...
document.getElementById("_listTransction").addEventListener("click", () => {
  const _idClient = document.getElementById("floatingInputUid").value;
  api
    .get(`/clients/${_idClient}/transactions`)
    .then((result) => {
      ...
      <li class="list-group-item list-group-item-success">Balance:</br> ${_balance.income}</br>${
          _balance.outcome
        }</br>${_balance.total} </li>
      <li class="list-group-item list-group-item-success">Transactions:</br>  ${
        transaction.id
      }</br> 
...
document.getElementById("_transaction").addEventListener("click", () => {
  ...
  api
    .get(`/clients/${_idClient}/transactions/${_idTransaction}`)
    .then((result) => {
...
document.getElementById("editTransaction").addEventListener("click", () => {
  ...
  api
    .put(`/clients/${_idClient}/transactions/${_idTransaction}`, {
      title: _title,
      value: _value,
      type: _type,
    })
...
document.getElementById("deleteTransaction").addEventListener("click", () => {
  ...
  var _idTransaction = document.getElementById("floatingInputTid").value;
  api
    .delete(`/clients/${_idClient}/transactions/${_idTransaction}`)
