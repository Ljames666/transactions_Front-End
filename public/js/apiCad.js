...
document.getElementById("_listTransction").addEventListener("click", () => {
  ...
  api
    ...
    .then((result) => {
      ...
      <li class="list-group-item list-group-item-success">Balance:
      </br>Income:            $ ${_balance.income}
      </br>Outcome:           $ ${_balance.outcome}
      </br>Balance available: $ ${_balance.total} </li>`;
        _transactions.forEach((transaction) => {
          printList.innerHTML += `
      <li class="list-group-item list-group-item-success">Transactions:
      </br>ID:  ${transaction.id}
      </br>Title:  ${transaction.title}
      </br>Value: ${transaction.value}
      </br>Type: ${transaction.type} </li>`;
        });
      }
    })
    .catch((err) => {
